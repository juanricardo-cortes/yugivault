      ...
      <div className="w-full max-w-sm space-y-8 text-center">
        ...
        <div className="rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-8 space-y-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-xl bg-white px-4 py-3 text-sm font-semibold text-slate-900 shadow-lg hover:bg-slate-100 active:scale-[0.98] transition-all"
          >
